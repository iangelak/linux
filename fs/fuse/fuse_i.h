...
struct fuse_conn {
	...
	/* Is the remote fsnotify/inotify capability supported by the
	 * filesystem? If yes then all the local inotify events related
	 * to inodes in the FUSE filesystem will be suppressed and only
	 * the remote events will be let through.
	 */
